...
class CarInterface(CarInterfaceBase):
  ...
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    if CP.carFingerprint in HONDA_BOSCH:
      ...
      if CP.enableGasInterceptor:
        return CarControllerParams.PEDAL_ACCEL_MIN, CarControllerParams.PEDAL_ACCEL_MAX
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long):
    ...
    if candidate in HONDA_BOSCH:
      ...
      ret.stoppingDecelRate = 0.04 # brake_travel/s while trying to stop
    else:
    ...
    if candidate == CAR.CIVIC:
      ...
      if eps_modified:
        ...
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 19200], [0, 3840]]
