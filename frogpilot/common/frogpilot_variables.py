...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme="stock", started=False):
    ...
    toggle.always_on_lateral_lkas = toggle.always_on_lateral and toggle.use_lkas_for_aol and (self.params.get_bool("AlwaysOnLateralLKAS") if tuning_level >= level["AlwaysOnLateralLKAS"] else default["AlwaysOnLateralLKAS"])
    toggle.always_on_lateral_main = toggle.always_on_lateral and not toggle.use_lkas_for_aol and (self.params.get_bool("AlwaysOnLateralMain") if tuning_level >= level["AlwaysOnLateralMain"] else default["AlwaysOnLateralMain"])
